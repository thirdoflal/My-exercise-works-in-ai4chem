...
# ╔═╡ f1ff9b16-53a2-4ee1-ab52-1fee6f3e360f
begin
	using CSV
	using DataFrames
...
begin
	...
	rename!(df_tox2, [:smiles, :toxic])

	smiles_list = df_tox2.smiles
	
	toxic_list = df_tox2.toxic

	print(smiles_list[1])
end


# ╔═╡ 32c1cbb8-4e3c-40b3-a16f-80386e66eec5
begin
	using PyCall
	Chem = pyimport("rdkit.Chem")
	feat = pyimport("deepchem.feat")
...
manifest_format = "2.0"
project_hash = "ac08e534b53b002339252a6d49de6bca9ab2d217"
